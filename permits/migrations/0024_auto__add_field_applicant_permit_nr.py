...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.permit_nr'
        db.add_column(u'permits_applicant', 'permit_nr',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['permits.Permit'], to_field='permit_nr', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.permit_nr'
        db.delete_column(u'permits_applicant', 'permit_nr_id')
