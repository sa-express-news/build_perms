...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Permit.latitude'
        db.add_column(u'permits_permit', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7, blank=True),
                      keep_default=False)

        # Adding field 'Permit.longitude'
        db.add_column(u'permits_permit', 'longitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Permit.latitude'
        db.delete_column(u'permits_permit', 'latitude')

        # Deleting field 'Permit.longitude'
        db.delete_column(u'permits_permit', 'longitude')
