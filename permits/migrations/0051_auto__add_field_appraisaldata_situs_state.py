...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppraisalData.situs_state'
        db.add_column(u'permits_appraisaldata', 'situs_state',
                      self.gf('django.db.models.fields.CharField')(default='Texas', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppraisalData.situs_state'
        db.delete_column(u'permits_appraisaldata', 'situs_state')
    ...
    models = {
        ...
        u'permits.appraisaldata': {
            ...
            'last_deed_date': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'situs_state': ('django.db.models.fields.CharField', [], {'default': "'Texas'", 'max_length': '255'}),
