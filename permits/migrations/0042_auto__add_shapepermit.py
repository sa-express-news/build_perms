...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShapePermit'
        db.create_table(u'permits_shapepermit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permit_nr', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('permit_dat', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('permit_typ', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('worktype', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('declvltn', self.gf('django.db.models.fields.FloatField')()),
            ('calcvltn', self.gf('django.db.models.fields.FloatField')()),
            ('temp_coodt', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('coodttm', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('latitude', self.gf('django.db.models.fields.FloatField')()),
            ('longitude', self.gf('django.db.models.fields.FloatField')()),
            ('geocode_ac', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('geom', self.gf('django.contrib.gis.db.models.fields.MultiPointField')()),
        ))
        db.send_create_signal(u'permits', ['ShapePermit'])


    def backwards(self, orm):
        # Deleting model 'ShapePermit'
        db.delete_table(u'permits_shapepermit')
