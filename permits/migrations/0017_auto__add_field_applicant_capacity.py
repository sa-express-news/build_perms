...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.capacity'
        db.add_column(u'permits_applicant', 'capacity',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.capacity'
        db.delete_column(u'permits_applicant', 'capacity')
