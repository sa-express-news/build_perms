...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CouncilDistrictsPost.geom'
        db.alter_column(u'permits_councildistrictspost', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=2238))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CouncilDistrictsPost.geom'
        db.alter_column(u'permits_councildistrictspost', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')())
    ...
    models = {
        ...
        u'permits.councildistrictspost': {
            ...
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '2238'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
