...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CouncilDistrictsPrior'
        db.delete_table(u'permits_councildistrictsprior')


    def backwards(self, orm):
        # Adding model 'CouncilDistrictsPrior'
        db.create_table(u'permits_councildistrictsprior', (
            ('web', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('district', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ...
            ('sq_miles', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('acres', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'permits', ['CouncilDistrictsPrior'])
