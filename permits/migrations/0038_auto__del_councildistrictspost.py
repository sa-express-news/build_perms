...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CouncilDistrictsPost'
        db.delete_table(u'permits_councildistrictspost')


    def backwards(self, orm):
        # Adding model 'CouncilDistrictsPost'
        db.create_table(u'permits_councildistrictspost', (
            ...
            ('district', self.gf('django.db.models.fields.FloatField')()),
            ('shape_leng', self.gf('django.db.models.fields.FloatField')()),
            ('sqmiles', self.gf('django.db.models.fields.IntegerField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shape_area', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'permits', ['CouncilDistrictsPost'])
