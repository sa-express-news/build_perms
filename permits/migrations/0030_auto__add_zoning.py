...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Zoning'
        db.create_table(u'permits_zoning', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('apno', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('zoning', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('descript', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('permit_nr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['permits.Permit'], to_field='permit_nr', null=True)),
        ))
        db.send_create_signal(u'permits', ['Zoning'])


    def backwards(self, orm):
        # Deleting model 'Zoning'
        db.delete_table(u'permits_zoning')
