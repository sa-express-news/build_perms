...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AppraisalData.city'
        db.alter_column(u'permits_appraisaldata', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):

        # Changing field 'AppraisalData.city'
        db.alter_column(u'permits_appraisaldata', 'city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
