...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Permit.temp_coodttm'
        db.add_column(u'permits_permit', 'temp_coodttm',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Permit.temp_coodttm'
        db.delete_column(u'permits_permit', 'temp_coodttm')
