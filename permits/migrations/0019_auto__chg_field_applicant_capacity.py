...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.capacity'
        db.alter_column(u'permits_applicant', 'capacity', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'Applicant.capacity'
        db.alter_column(u'permits_applicant', 'capacity', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
