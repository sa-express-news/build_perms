...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Permit.geocode_accuracy'
        db.add_column(u'permits_permit', 'geocode_accuracy',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Permit.geocode_accuracy'
        db.delete_column(u'permits_permit', 'geocode_accuracy')
