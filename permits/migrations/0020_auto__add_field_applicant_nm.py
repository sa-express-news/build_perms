...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.nm'
        db.add_column(u'permits_applicant', 'nm',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.nm'
        db.delete_column(u'permits_applicant', 'nm')
    ...
    models = {
        u'permits.applicant': {
            ...
            'nm': ('django.db.models.fields.TextField', [], {'null': 'True'}),
