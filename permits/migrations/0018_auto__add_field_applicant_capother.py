...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.capother'
        db.add_column(u'permits_applicant', 'capother',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.capother'
        db.delete_column(u'permits_applicant', 'capother')
    ...
    models = {
        u'permits.applicant': {
            ...
            'capacity': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
